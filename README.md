...
1. Suit Up with Variables

Set your constants: Vegetarian, Hawaiian, Pepperoni, and pizzaPrice.
Ready the welcome message with alert().
2. Engage with Prompts

Deploy prompt() to get the user's pizza choice into orderName.
Launch another prompt() for the orderQuantity.
3. Calculate and Report

Use orderQuantity and pizzaPrice to determine orderTotal.
Inform the user of their order and cost with alert().
4. Recon with Conditionals

Confirm pizza choice is valid.
Estimate cooking time and add it to the order message.
5. Delegate to Functions

Craft checkOrderName(orderName).
Forge totalCost(orderQuantity).
Construct cookingTime(orderQuantity).
6. Upgrade to HTML UI

Construct a form in HTML for user input.
Command your program to respond within the HTML document.
7. Establish a GitHub Base

Initialize a new repo.
Add, commit, and push your files to GitHub.
8. Mission Debriefing

Submit the GitHub repo link via Canvas.
Reading Up

Strengthen your knowledge with the provided MDN links.
Call for Backup

When stuck, advance through the help steps: Google, comrades, Slack, David.
Mission Accomplished!

With this, your web dev and problem-solving skills will be sharper.
Now, get coding and conquer this assignment! Stay hard!# pizzaForChas
